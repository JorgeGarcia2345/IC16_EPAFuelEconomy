...
public class MainScene extends Scene {
    ...
    public MainScene() {
        ...
        vehiclesLV.getSelectionModel().selectedItemProperty().addListener((obsVal, oldVal, newVal) -> selectVehicle(newVal));
    ...
    private void selectVehicle(Vehicle newVal) {
    ...
    private void addVehicle() {
        ...
        ViewNavigator.loadScene("Adding Vehicle Now :)", new AddScene(this));
    }
