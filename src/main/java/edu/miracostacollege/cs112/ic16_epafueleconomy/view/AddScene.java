package edu.miracostacollege.cs112.ic16_epafueleconomy.view;

import edu.miracostacollege.cs112.ic16_epafueleconomy.controller.Controller;
...
public class AddScene extends Scene {
    ...
    private void save() {
        ...
        if(yearErrorLabel.isVisible() || makeErrorLabel.isVisible() ||
                modelErrorLabel.isVisible() || cityMPGErrorLabel.isVisible() || annualFuelCostErrorLabel.isVisible() ||
                fuelEconomyRatingErrorLabel.isVisible() || fuelEconomyRatingErrorLabel.isVisible())
            return;
