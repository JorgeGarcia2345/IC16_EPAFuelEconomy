package edu.miracostacollege.cs112.ic16_epafueleconomy.model;
	...
	public static ObservableList<Vehicle> populateListFromCSVFile() {
		...
		try {
			...
			while (fileScanner.hasNextLine()) {
				...
				make.substring(0, make.length()).toLowerCase();
				//String makeToInsert = make.substring(0, 1).toUpperCase() + make.substring(1);
